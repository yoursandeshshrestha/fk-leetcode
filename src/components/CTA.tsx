      ...
      <div className="relative w-full max-w-[1280px] mx-auto">
        ...
        <div className="relative -mx-6">
          <div className="relative flex flex-col lg:flex-row">
            ...
            <div className="w-full lg:w-1/2 p-12 border-r border-white/10">
